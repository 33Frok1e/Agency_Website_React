      ...
      <div className='px-4 lg:px-14 max-w-screen-2xl mx-auto my-8 bg-neutralSilver py-16'>
        <div className='flex flex-col md:flex-row justify-between items-center gap-8'>
          <div className='md:w-1/2'>
            <h2 className='text-4xl font-semibold text-neutralDGrey mb-4 md:w-2/3'>Helping a local<br /><span className='text-brandPrimary'>business reinvent itself</span></h2>
          ...
          <div className='md:w-1/2 mx-auto flex sm:flex-row flex-col sm:items-center justify-around gap-12'>
            ...
            <div className='space-y-8'>
              ...
              <div>
                <h4 className='text-2xl text-neutralDGrey font-semibold'>1,926,345</h4>
                <p>Payments</p>
              </div>
              </div>
            </div>

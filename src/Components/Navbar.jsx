  ...
  return (
    <header className="w-full bg-white md:bg-transparent fixed z-50 top-0 left-0 right-0">
      ...
      >
        ...
        className="flex justify-between items-center text-base gap-8">
          <a
            className="text-2xl flex items-center space-x-3 font-semibold"
            href=""
          >
            <img
              ...
              alt="logo"
            />
            <span className="text-[#263238]">QUIRKY</span>
          </a>
          ...
          <div className="md:hidden">
            <button
              onClick={toggleMenu}
              className="text-neutralDGrey focus:outline-none focus:text-neutralDGrey"
            >
              {isMenuOpen ? (
